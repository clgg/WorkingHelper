...
public class ProductListAdapter extends BaseAdapter {
    ...
    private ArrayList<ProductBrief> mList;
    private LayoutInflater mInflater;

    public ProductListAdapter(Context context, ArrayList<ProductBrief> list) {
    ...
    public View getView(int position, View convertView, ViewGroup viewGroup) {
        ...
        ImageLoader.getInstance().displayImage(mList.get(position).getPhoto().get(0),holder.productImage);
        holder.productTitle.setText(mList.get(position).getName());
